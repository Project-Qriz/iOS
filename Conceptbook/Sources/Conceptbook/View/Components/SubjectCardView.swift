...
extension SubjectCardView {
    private func addSubviews() {
        [imageView, titleLabel, itemCountLabel].forEach { addSubview($0) }
    }
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            itemCountLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: Metric.itemCountLabelTopOffset),
