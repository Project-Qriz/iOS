...
extension UINavigationBar {
    ...
    static func defaultBackButtonStyle() -> UINavigationBarAppearance {
        ...
        if let backImage = UIImage(systemName: "chevron.left")?.withTintColor(.black, renderingMode: .alwaysOriginal) {
            let offsetImage = backImage.withAlignmentRectInsets(UIEdgeInsets(top: 0, left: -10, bottom: 0, right: 10))
