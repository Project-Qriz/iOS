...
final class TestNavigatorButton: UIView {
    ...
    // MARK: - Methods
    func setDailyUI(state: DailyTestState, type: DailyLearnType, score: CGFloat?) {
    ...
    func setMockExamUI(isTestDone: Bool, examRound: Int, score: CGFloat?) {
    ...
    private func updateScoreLabel(score: CGFloat?) {
