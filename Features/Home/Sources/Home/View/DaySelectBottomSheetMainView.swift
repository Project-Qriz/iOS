...
final class DaySelectBottomSheetMainView: UIView {
    ...
    private enum Metric {
        ...
        static let nextTrailingOffset: CGFloat = 29.0
        static let prevTrailingOffset: CGFloat = 23.0
        static let collectionTop: CGFloat = 25.0
        static let lineSpacing: CGFloat = 12.0
        static let interitemSpacing: CGFloat = 8.0
        static let columnCount: CGFloat = 4.0
    ...
    override func layoutSubviews() {
        ...
        let totalSpacing = spacing * (Metric.columnCount - 1)
        let availableWidth = collectionView.bounds.width - Metric.horizontalMargin - totalSpacing
        let cellWidth = floor(availableWidth / Metric.columnCount)
        flow.itemSize = CGSize(width: cellWidth, height: Metric.cellHeight)
    }
...
extension DaySelectBottomSheetMainView {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            weekLabel.leadingAnchor.constraint(equalTo: titleLabel.leadingAnchor),

            nextButton.topAnchor.constraint(equalTo: weekLabel.topAnchor),
            nextButton.trailingAnchor.constraint(
                equalTo: trailingAnchor,
                constant: -Metric.nextTrailingOffset
            ),

            prevButton.topAnchor.constraint(equalTo: weekLabel.topAnchor),
            prevButton.trailingAnchor.constraint(
                equalTo: nextButton.leadingAnchor,
                constant: -Metric.prevTrailingOffset
            ),
