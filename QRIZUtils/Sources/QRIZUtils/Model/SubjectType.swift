...
public enum ConceptCategory: CaseIterable {
    public enum DataModeling: String, CaseIterable {
        ...
        public static func from(concept: String) -> DataModeling? {
    ...
    public enum DataModelAndSQL: String, CaseIterable {
        ...
        public static func from(concept: String) -> DataModelAndSQL? {
            allCases.first { $0.rawValue == concept }
        }
    ...
    public enum SQLBasic: String, CaseIterable {
        ...
        public static func from(concept: String) -> SQLBasic? {
            allCases.first { $0.rawValue == concept }
        }
    ...
    public enum SQLAdvanced: String, CaseIterable {
        case subQuery = "서브 쿼리"
        ...
        public static func from(concept: String) -> SQLAdvanced? {
            allCases.first { $0.rawValue == concept }
        }
    ...
    public enum SQLCommands: String, CaseIterable {
        case dml = "DML"
        case tcl = "TCL"
        case ddl = "DDL"
        case dcl = "DCL"
        ...
        public static func from(concept: String) -> SQLCommands? {
            allCases.first { $0.rawValue == concept }
        }
