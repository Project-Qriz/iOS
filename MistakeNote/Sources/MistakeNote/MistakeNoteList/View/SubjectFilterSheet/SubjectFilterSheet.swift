...
public struct SubjectFilterSheet: View {
...
public struct SubjectTabSelector: View {

    @Binding public var selectedSubject: Subject

    // MARK: - Initializer

    public init(selectedSubject: Binding<Subject>) {
